...
class thoughtPage2 extends StatefulWidget {
  const thoughtPage2({super.key});

  @override
  State<thoughtPage2> createState() => _thoughtPage2State();
}

class _thoughtPage2State extends State<thoughtPage2> {
  @override
...
List<GlobalKey> posKey3 = List.generate(beStrong.length, (index) => GlobalKey());
